...
<img src="/m/uploads/2015/01/SDL_logo.png" title="SDLv2" class="left m10">All of our builds have switched to using the latest-and-greatest major version of the SDL: version 2.0. This version brings with it several performance improvements and a ton of [new capabilities](https://wiki.libsdl.org/SDL2/MigrationGuide#overview-of-new-features).
